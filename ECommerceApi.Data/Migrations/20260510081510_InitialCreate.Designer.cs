...
namespace ECommerceApi.Data.Migrations
{
    ...
    [Migration("20260510081510_InitialCreate")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("ECommerceApi.Data.Models.Payment", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("ECommerceApi.Data.Models.Wishlist", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("ECommerceApi.Data.Models.Cart", b =>
                {
                    b.HasOne("ECommerceApi.Data.Models.ApplicationUser", "User")
                        .WithOne("Cart")
                        .HasForeignKey("ECommerceApi.Data.Models.Cart", "UserId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
            ...
            modelBuilder.Entity("ECommerceApi.Data.Models.Category", b =>
                {
                    b.HasOne("ECommerceApi.Data.Models.Category", "Parent")
            ...
            modelBuilder.Entity("ECommerceApi.Data.Models.Payment", b =>
                {
                    b.HasOne("ECommerceApi.Data.Models.Order", "Order")
                        .WithOne("Payment")
                        .HasForeignKey("ECommerceApi.Data.Models.Payment", "OrderId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
            ...
            modelBuilder.Entity("ECommerceApi.Data.Models.Product", b =>
                {
                    ...
                    b.HasOne("ECommerceApi.Data.Models.ApplicationUser", "Seller")
                        .WithMany("Products")
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityUserClaim<string>", b =>
                {
                    b.HasOne("ECommerceApi.Data.Models.ApplicationUser", null)
                        .WithMany()
                        .HasForeignKey("UserId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
